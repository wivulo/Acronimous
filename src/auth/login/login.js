	    ...
	    <div className="block flex flex-column bg-darkblue-palette" id="block">
		    ...
		    <section className="block-2 flex flex-column flex-center">
			    ...
			    <div className="block-2-3 flex flex-column flex-h-center bg-darkblue-palette-3">
				    <button className="signUp btn-radius btn-radius-neon" id="signUp"><a href="/register" data-link>criar conta</a></button>
				    <button className="forgot btn-radius btn-radius-neon" id="forgot"><a href="/forgot" data-link>Esqueci a palavra-passe</a></button>
			    </div>
		    </section>
	    </div>
    </div>
